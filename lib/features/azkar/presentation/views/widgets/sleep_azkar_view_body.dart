...
class SleepAzkarViewBody extends StatefulWidget {
  const SleepAzkarViewBody({super.key});

  @override
  State<SleepAzkarViewBody> createState() => _SleepAzkarViewBodyState();
}

class _SleepAzkarViewBodyState extends State<SleepAzkarViewBody> {
  @override
  void initState() {
    super.initState();
    BlocProvider.of<GetAzkarCubit>(context).getAzkarCubit(categoryAzkarCubit: 'sleep_azkar');
    setState(() {});
  }
